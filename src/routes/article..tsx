...
function ArticlePage() {
  ...
  // Related — search a few keywords from the title
          ...
          <div className="border border-border bg-card p-8 text-center">
            ...
            {url && (
              <div className="mt-6 flex flex-col sm:flex-row gap-2 justify-center">
                <button
                  onClick={() => pickMode("extracted")}
                  className="inline-flex items-center justify-center gap-2 bg-secondary px-4 py-2 text-secondary-foreground font-bold uppercase text-sm tracking-wide"
                >
                  Try reader view
                </button>
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-primary px-4 py-2 text-primary-foreground font-bold uppercase text-sm tracking-wide"
                >
...
function ExtractedView({
  ...
  return (
    <div>
      ...
      <div
        className="np-reader prose prose-neutral dark:prose-invert max-w-none"
